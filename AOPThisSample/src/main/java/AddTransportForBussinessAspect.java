...
public class AddTransportForBussinessAspect implements Ordered {
    ...
    @DeclareParents(value = "com.xgj.aop.spring.advisor.aspectJ.function.thisFun.BussinessService", defaultImpl = com.xgj.aop.spring.advisor.aspectJ.function.thisFun.TransportService.class)
